            ...
            <div class="row g-5">
                <div class="col-sm-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-white-50 mb-2" href="<?= base_url('user/info_pemesanan'); ?>"><i class="fa fa-angle-right me-2"></i>Informasi Pemesanan</a>
                        <a class="text-white-50" href="<?= base_url('user/info_pembayaran'); ?>"><i class="fa fa-angle-right me-2"></i>Informasi Pembayaran</a>
                    </div>
                </div>
            </div>
        </div>
